...
const Footer = () => {
  ...
  return (
    <div className='w--full min-h-[40vh] bg-zinc-900'>
            ...
            <div className="center sm:w-[40vw] w-full sm:ml-0 ml-32 flex sm:flex-row flex-col justify-between pt-10 h-full sm:mt-6">
                <div>
                    <h1 className='text-[2rem] font-semibold'>About</h1>
                    {
                      about.map((item,index)=>(
                          <ul key={index} className='text-zinc-400 list-disc '>
                ...
                <div>
                    <h1 className='text-[2rem] font-semibold'>Contacts</h1>
                      <h3 className='text-zinc-400 mt-1 text-sm'>Call : 99999999</h3>
                      <h3 className='text-zinc-400 mt-1 text-sm'>Email : <br /> <a href="">codeinshort@gmail</a></h3>
                </div>
        ...
        <div className='h-[10vh] sm:w-full w-[90vw] flex justify-center items-center bg-[#1101445d]'>
